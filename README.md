...
## Important
First things you have to do is, clone this repository [linepy-modified](https://github.com/404notsurrender/linepy-modified)
...
$ apt install python
$ apt install git
$ git clone https://github.com/404notsurrender/selfbot-py
$ cd selfbot-py
